...
import { BookOpen, Award, ClipboardList, TrendingUp, Clock, Star, ArrowRight, Zap } from 'lucide-react';
import api from '../../api';
...
export default function StudentDashboard() {
  ...
  const stats = [
    ...
    { label: 'Assignments', value: assignments.length, icon: ClipboardList, color: 'text-violet-400', bg: 'bg-violet-400/10 border-violet-400/20', link: '/student/assignments' },
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm text-amber-400 font-medium">Good day</span>
            </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1.5">
                        <div className="progress-track flex-1 h-1.5">
                          <div className="progress-fill" style={{width:`${enr.progress || 0}%`, height:'100%'}} />
                        </div>
                        <span className="text-xs text-[#9090b8] w-8 text-right">{enr.progress || 0}%</span>
                      </div>
                    </div>
