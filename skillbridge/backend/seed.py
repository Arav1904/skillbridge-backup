...
def seed_courses():
    ...
    courses_data = [
        {"course_id": 1, "level": "Beginner", "course_title": "Python for Beginners",          "description": "Learn Python from scratch. Covers data types, loops, functions, OOP and file handling.",           "duration": 30, "category_id": 1, "instructor_id": 1},
        {"course_id": 2, "level": "Intermediate", "course_title": "Data Science with Pandas",      "description": "Master data analysis using Pandas, NumPy and Matplotlib with real-world datasets.",               "duration": 40, "category_id": 2, "instructor_id": 1},
        {"course_id": 3, "level": "Advanced", "course_title": "Full Stack Web Development",    "description": "Build complete web apps with React frontend and FastAPI backend. Deploy to cloud.",               "duration": 60, "category_id": 3, "instructor_id": 2},
        {"course_id": 4, "level": "Intermediate", "course_title": "PostgreSQL Mastery",            "description": "Deep dive into relational databases — queries, indexes, transactions, stored procedures.",       "duration": 25, "category_id": 4, "instructor_id": 2},
        {"course_id": 5, "level": "Beginner", "course_title": "Cloud & DevOps Fundamentals",  "description": "AWS core services, Docker, CI/CD pipelines and Infrastructure as Code with Terraform.",         "duration": 45, "category_id": 5, "instructor_id": 3},
    ]
